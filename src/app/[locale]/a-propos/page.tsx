    ...
    <main style={{ background: "var(--surface-page)" }}>
      ...
      <section style={{ maxWidth: 880, margin: "0 auto", padding: "72px 24px" }}>
        <div style={{ fontFamily: "var(--font-sans)", fontWeight: 300, fontSize: "1.0625rem", lineHeight: 1.85, color: "var(--ink-700)" }}>
          ...
          <p style={{ margin: 0 }}>Dix ans plus tard, Dubaï Parfumerie c&apos;est 300+ références authentiques, 15 maisons partenaires, plus de 7000 produits vendus et une note de 4,8/5 sur Trustpilot. Mais surtout, une promesse intacte : chaque parfum est vrai, sourcé directement, et accompagné de son certificat manuscrit.</p>
        </div>
      </section>
