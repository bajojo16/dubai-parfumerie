        ...
        >
          {brands.map((brand) => {
            ...
            >
              ...
              >
                {/* `contain` et non `cover` : ces visuels sont des logos, pas
                    des photos. En `cover`, « AL » disparaissait du Haramain et
                    « SINCE 1970 » se coupait en bas — un logo rogné n'identifie
                    plus la maison. La marge autour vient du fond de la boîte. */}
                <Image
                  src={brand.image}
