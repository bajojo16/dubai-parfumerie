...
export const DEMO: Pack[] = [
  {
    ...
    image: "/assets/products/dp_parfumerie-dubai-parfumerie-pack-echantillons-5-fioles.webp",
    price: 9,
    priceFrom: true,
    badge: "bestseller",
    available: true,
  ...
  },
  {
    ...
    image: "/assets/products/dp_parfumerie-dubai-parfumerie-pack-echantillons-3-fioles.webp",
    price: 9,
    priceFrom: true,
    badge: "most_gifted",
    available: true,
